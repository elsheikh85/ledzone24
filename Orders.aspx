<%@ Page Title="جميع الطلبات" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Orders.aspx.cs" Inherits="Orders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container" dir="rtl" align="center">
        <h2>جميع الطلبات</h2>
        <asp:DropDownList ID="OrderDateDropDownList" runat="server" class="form-control" style="text-align: center" AutoPostBack="true" OnSelectedIndexChanged="OrderDateDropDownList_SelectedIndexChanged">
        </asp:DropDownList>
        <hr />
         <div class="table-responsive">
        <asp:GridView ID="OrdersGridView" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" EmptyDataText="لا توجد طلبات" OnRowCommand="OrdersGridView_RowCommand">
            <Columns>
